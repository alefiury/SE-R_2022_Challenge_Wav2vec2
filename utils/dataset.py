...
class DataColletor:
    ...
    Args:
        ...
        pad_to_multiple_of (:obj:`int`, `optional`):
            ...
            7.5 (Volta).
    """
    def __init__(self, processor, audio_augmentator=None, sampling_rate=16000, padding=True, test=False, max_length=None, max_length_labels=None, pad_to_multiple_of=None, pad_to_multiple_of_labels=None, apply_dbfs_norm=False, target_dbfs=0.0):
...
class DataColletorTest:
    ...
    Args:
        ...
        pad_to_multiple_of (:obj:`int`, `optional`):
            ...
            7.5 (Volta).
    """
    def __init__(self, processor, sampling_rate=16000, padding=True, test=False, max_length=None, pad_to_multiple_of=None, apply_dbfs_norm=False, target_dbfs=0.0):
        self.processor = processor
        self.sampling_rate = sampling_rate
        self.padding = padding
        self.max_length = max_length
